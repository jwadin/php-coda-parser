...
{
    private TransactionCodeFamily $family;
    private TransactionCodeType $type;
    private TransactionCodeOperation $operation;
    private TransactionCodeCategory $category;
